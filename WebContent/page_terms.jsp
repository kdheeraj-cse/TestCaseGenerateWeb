...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">LOL There are no Terms and conditions</h1>
				<p class="tagline">Use this tool as you want</p>
				<p><a class="btn btn-default btn-lg" role="button">HOW TO USE</a></p>
			</div>
		</div>
	</header>
	<!-- /Header -->
