				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">Or register a new account, <a href="signup.jsp">Register</a> It is completely free. </p>
							<hr>
							<!--  HTML FORM -->
							<form method="post" action="userLogin.do">
								<div class="top-margin">
									<label>Userid/Email <span class="text-danger">*</span></label>
								...
								<div class="row">
									<div class="col-lg-8">
										<b><a href="forgot.jsp">Forgot password?</a></b>
									</div>
